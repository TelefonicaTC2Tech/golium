Feature: Common
  ...
  @common
  Scenario: Parse URL
    Given I parse the URL "https://www.telefonica.es:443/products-services/solutions?a=1&b=test" in context "url"
     Then the value "[CTXT:url.scheme]" must be equal to "https"
      And the value "[CTXT:url.host]" must be equal to "www.telefonica.es:443"
      And the value "[CTXT:url.hostname]" must be equal to "www.telefonica.es"
